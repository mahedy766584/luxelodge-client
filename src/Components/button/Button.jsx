...
const Button = ({children}) => {
    return (
        <>
            ...
            <button className="relative overflow-hidden font-medium  py-3 px-10 bg-silver hover:text-silver duration-300 hover:animate-none animate-bounce top-6 text-navyGray font-kanit  group">
