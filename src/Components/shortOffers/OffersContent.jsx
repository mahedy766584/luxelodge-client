        ...
        <div className="lg:flex items-center justify-between  gap-20 flex-row-reverse space-y-20 lg:mt-0  mt-28">
            ...
            <div className="relative">
                <div className="relative flex">
                    <div className="absolute bg-silver rounded-full lg:w-80px lg:h-80 md:w-80 md:h-80 w-60 h-60 flex justify-center items-center z-0 animate-bounce duration-700 -top-28 lg:top-0">
            ...
            <div className="text-silver flex flex-col items-start lg:text-start text-justify lg:px-0 px-4 flex-1  space-y-4">
                <h1 className="font-kanit text-4xl font-medium lg:text-start text-center">Exclusive Offers Just for You</h1>
                <p className="font-poppins text-xl font-normal text-wrap">
