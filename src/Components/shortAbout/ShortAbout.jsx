...
const ShortAbout = () => {
    return (
        <div>
            <Container>
                <div className="lg:flex relative md:px-6 lg:gap-10 dark:text-silver items-center lg:mt-52 md:mt-72 mt-[460px]">
                    {/* about slider here */}
                    ...
                    {/* content here */}
                    <div className="flex-1 space-y-5 lg:mt-0 mt-10 lg:text-start lg:px-0 text-justify  relative">
                        <div className="lg:text-start flex justify-center items-center lg:justify-start lg:items-start text-center">
                            <h1 className="lg:text-5xl text-2xl flex items-center gap-2 font-semibold font-kanit text-redBg">
                        ...
                        <p className="text-xl font-poppins text-navyGray dark:text-silver text-pretty font-normal">
                        ...
                        <div className="space-y-4">
                            <h1 className="text-navyGray font-semibold text-center text-3xl dark:text-silver lg:justify-start lg:text-start">Our Mission</h1>
                            <p className="text-xl font-poppins text-navyGray dark:text-silver font-normal text-pretty">
